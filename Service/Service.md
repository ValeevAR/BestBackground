...
Проверить, что сервер запущен, можно перейдя в http://127.0.0.1:8080/health .
...
Ожидаемые характеристики в разных режимах работы: \
на CPU: 0.1 RPS, 11000 ms 99_latency \
на GPU: 1.1 RPS,   950 ms 99_latency